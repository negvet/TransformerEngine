...
def _initialize_framework_extensions() -> None:
    """Imports framework subpackages (PyTorch, JAX) so their
    binary extensions are loaded and Python bindings become available."""
    # Skip initialization in python-only mode.
    if _PYTHON_ONLY:
        return
...
_initialize_framework_extensions()
