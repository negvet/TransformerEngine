...
def is_experimental(x: Optional[Union[Quantizer, QuantizedTensor, QuantizedTensorBase]] = None) -> bool:
    ...
    if isinstance(x, torch.Tensor):
        return False
    if not isinstance(x, (Quantizer, QuantizedTensor, QuantizedTensorBase)):
        raise AssertionError("Object must be a Quantizer, QuantizedTensor, or QuantizedTensorBase instance")
